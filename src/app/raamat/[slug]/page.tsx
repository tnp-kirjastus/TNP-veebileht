...
import { getCategories, getPersonByName, getProductBySlug, getRelatedProducts, getSameSeriesProducts, getSameAuthorProducts, isOnSale, formatEuro, formatDate, formatEditions, type Product } from "@/lib/data";
