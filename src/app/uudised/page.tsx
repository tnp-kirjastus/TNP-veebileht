...
export const metadata: Metadata = { title: "Uudised" };

export default async function NewsPage() {
  const posts = await getPublishedPosts();
  return <LayoutFull>
    <section className="py-[28px]" />
    <Shell><h1 className="font-heading font-medium text-[clamp(42px,7vw,78px)] leading-[1.15] py-12 max-w-[860px]">Uudised</h1>
      <div className="grid gap-[34px] pb-12 max-w-[860px]">
