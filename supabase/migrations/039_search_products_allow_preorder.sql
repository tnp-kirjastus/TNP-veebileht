-- Migration 039: search_products väljundisse lisandub allow_preorder.
-- Ilmuvad raamatud, millel ettetellimist pole, kuvatakse storefront'is ilma
-- hinnata — loetelude kaardid vajavad seetõttu allow_preorder väärtust.
-- Signatuur ei muutu (tagastus on endiselt JSONB).
  ...
  RETURN (
    WITH filtered AS MATERIALIZED (
      SELECT
        ...
        p.cover_image, p.is_upcoming, p.allow_preorder, p.is_archived, p.stock,
