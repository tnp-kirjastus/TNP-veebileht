-- Migration 037: search_products parandus — parameetrid sale_start/sale_end
-- põrkusid products-tabeli samanimeliste veergudega ("column reference is
-- ambiguous"). Lahendus: #variable_conflict use_variable (signatuur ei muutu).
